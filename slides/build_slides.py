...
<section class="slide active">
  ...
  <p class="sub" style="margin-top:1.4rem">Naissance, diffusion et mort des formules politiques dans <strong>l'intégralité</strong> des débats de l'Assemblée nationale, via l'API de transcription que nous avons construite à partir des données publiques de l'Assemblée et mise à disposition du hackathon.</p>
...
<section class="slide">
  ...
  <ul class="method">
    <li><strong>Corpus intégral</strong> via notre API de transcription, construite sur les données publiques de l'Assemblée et mise à disposition du hackathon — pas d'échantillon, pas de recherche plafonnée.</li>
